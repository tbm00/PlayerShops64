...
public class AssistantGui {
    ...
    private String label = "Manage Assistants";
    
    public AssistantGui(PlayerShops64 javaPlugin, Player viewer, UUID shopUuid, boolean isAdmin) {
        ...
        fillPlayers(javaPlugin.getShopHandler().getShop(shopUuid));
        setupFooter();
    ...
    private void addGuiItemAssistant(UUID playerUuid) {
        ...
        gui.addItem(ItemBuilder.from(headItem).asGuiItem(event -> {
                                                            ...
                                                            gui.setCloseGuiAction(null);
                                                            new AssistantGui(javaPlugin, viewer, playerUuid, isAdmin);
                                                        }));
    }
}